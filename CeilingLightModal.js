// CeilingLightModal.js
import React, { useState } from "react";
import { Modal, View, Text, TouchableOpacity, StyleSheet, Dimensions } from "react-native";
import { FontAwesome } from "@expo/vector-icons";
import { GestureHandlerRootView, PanGestureHandler } from 'react-native-gesture-handler';

const CeilingLightModal = ({ visible, onClose }) => {
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.header}>
                ...
                <Text style={styles.roomTitle}>Ceiling Light</Text>
                <TouchableOpacity onPress={() => setLightOn(!lightOn)}>
                  <View style={[styles.toggleButton, lightOn ? styles.toggleOn : styles.toggleOff]}>
              ...
              <View style={styles.controlPanel}>
                <TouchableOpacity style={styles.controlButton} onPress={() => setMode("Warm")}>
                  <FontAwesome name="sun-o" size={20} color="#008CBA" />
                  <Text style={styles.controlButtonText}>WARM</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.controlButton} onPress={() => setMode("Colorful")}>
                  <FontAwesome name="paint-brush" size={20} color="#008CBA" />
                  <Text style={styles.controlButtonText}>COLORFUL</Text>
                </TouchableOpacity>
              </View>
...
export default CeilingLightModal;
